...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AIED Integrated School System" },
      {
        name: "description",
        content:
          "AI-assisted worksheets for schools: instant tutoring feedback for students and progress insights for teachers.",
      },
      { name: "author", content: "AIED" },
